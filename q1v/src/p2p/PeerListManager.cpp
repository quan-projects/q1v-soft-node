...
PeerlistManager::PeerlistManager() : m_whitePeerlist(m_peers_white, Q1v::P2P_LOCAL_WHITE_PEERLIST_LIMIT),
                                     m_grayPeerlist(m_peers_gray, Q1v::P2P_LOCAL_GRAY_PEERLIST_LIMIT) {}
