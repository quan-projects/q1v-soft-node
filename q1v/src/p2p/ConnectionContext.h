...
namespace Q1v {
    ...
    struct CryptoNoteConnectionContext {
        ...
        enum state {
            ...
            state_synchronizing, state_idle, state_normal, state_sync_required, state_pool_sync_required, state_shutdown
        };
...
namespace std {
    inline std::ostream &operator<<(std::ostream &s, const Q1v::CryptoNoteConnectionContext &context) {
