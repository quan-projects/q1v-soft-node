...
/************************************************************************/
    class PeerlistManager {
        ...
        typedef boost::multi_index_container<PeerlistEntry, boost::multi_index::indexed_by<
                ...
                boost::multi_index::ordered_non_unique<boost::multi_index::tag<by_time>, boost::multi_index::member<PeerlistEntry, uint64_t, &PeerlistEntry::last_seen> > > > peers_indexed;
    ...
    public:
        ...
        bool get_peerlist_head(std::list<PeerlistEntry> &bs_head,
                               uint32_t depth = Q1v::P2P_DEFAULT_PEERS_IN_HANDSHAKE) const;
