...
namespace Q1v {
    ...
    namespace TransactionTypes {
        ...
        enum class InputType : uint8_t {
            Invalid, Key, Multisignature, Generating
        };
        enum class OutputType : uint8_t {
            Invalid, Key, Multisignature
        };
...
// 
    ...
    public:
        ...
        virtual size_t
        addOutput(uint64_t amount, const std::vector<AccountPublicAddress> &to, uint32_t requiredSignatures) = 0;
        ...
        virtual void
        signInputMultisignature(size_t input, const Crypto::PublicKey &sourceTransactionKey, size_t outputIndex,
